...
execute: target/text-to-speech-polling-api-example-1.0.0.jar
...
target/text-to-speech-polling-api-example-1.0.0.jar: src/main/java/com/narakeet/*.java pom.xml
	$(RUN) mvn compile
